...
triggerSelectionMC          = 'HLT_Mu17_Mu8_v17 OR HLT_Mu17_TkMu8_v10' # not recommended
...
triggerObjectSelectionMC          = 'type("TriggerMuon") && ( path("HLT_Mu17_Mu8_v17") || path("HLT_Mu17_TkMu8_v10") )' # not recommended
