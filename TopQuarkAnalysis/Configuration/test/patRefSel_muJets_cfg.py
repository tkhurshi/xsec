...
inputFiles = ['file:../../../../../CMSSW_5_3_5/src/MC/Summer12_DR53X_TTJets_MassiveBinDECAY_TuneZ2star_8TeV-madgraph-tauola_AODSIM_PU_S10_START53_V7A-v1.root'] # overwritten, if "useRelVals" is 'True'

# maximum number of events
maxEvents = 1000 # reduce for testing
